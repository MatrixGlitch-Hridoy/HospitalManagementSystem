...
?>            
              <tr>
                ...
                <td><a onclick="return confirm('Are you sure you want to delete this Patient?');"  href="delete.php?deleteid=<?php echo $value['id']; ?>" class="delete btn-delete btn-big">delete</a></td>
              </tr>
              <?php 
                }
}
